...
export function ArtistCard({ artist, onAdd, added, disabled }) {
  ...
  return (
    <div
      ...
      onClick={() => !isDisabled && onAdd(artist)}
      onKeyDown={e => e.key === 'Enter' && !isDisabled && onAdd(artist)}
      style={{
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0, fontFamily: 'var(--font-display)', fontWeight: 500, fontSize: '14px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
        {artist.name}
      </div>
